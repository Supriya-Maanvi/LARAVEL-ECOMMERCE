                    ...
                    <div class="panel-body"> 
                        ...
                        <form action="" class="form-horizontal" wire:submit.prevent="updateCoupon">
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="code" placeholder="Coupon Code" class="form-control input-md" wire:model="code"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="value" placeholder="Value" class="form-control input-md" wire:model="value"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" name="cart_value" placeholder="Cart Value" class="form-control input-md" wire:model="cart_value"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4" wire:ignore>
                                    <input type="text" id="expiry_date" name="expiry_date" placeholder="Expiry Date" class="form-control input-md" wire:model="expiry_date"/>
