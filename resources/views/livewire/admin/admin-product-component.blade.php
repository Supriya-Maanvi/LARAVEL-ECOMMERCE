                                ...
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" style="margin-left: 10px;" onclick="confirm('Are you sure, You want to delete this category..?') || event.stopImmediatePropagation()" wire:click.prevent="deleteProduct({{$product->id}})"><i class="fa fa-times fa-2x text-danger"></i></a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
